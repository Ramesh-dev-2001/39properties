    ...
    <div class="row">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            <a class="btn btn-sm btn-primary" href="<?php echo AGENT_URL?>/views/properties/propertieslist.php">
                Properties
            </a>
          </div>
        </div>
          <div class="col-md-7 col-lg-8">
            ...
            <input type='hidden' name="masterAgentId" id="masterAgentId" value="<?php echo $agentId;?>">
                ...
                <div class="col-md-6">
                  <div class="input-group has-validation">
                    <select class="form-select" id="hall" name="hall">
                      ...
                      <?php 
                        for($i=1;$i<=5;$i++){
                          $selected = (isset($propertyDetails['hall']) && $i == $propertyDetails['hall'])?'selected':'';
                          echo '<option value="'.$i.'"'.$selected.'>'.$i.' </option>';
                          }?>
                    </select>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                  <div class="input-group has-validation">
                    <select class="form-select" id="balcony" name="balcony">
                      ...
                      <?php 
                        for($i=1;$i<=5;$i++){
                          $selected = (isset($propertyDetails['balcony']) && $i == $propertyDetails['balcony'])?'selected':'';
                          echo '<option value="'.$i.'"'.$selected.'>'.$i.' </option>';
                          }?>
                    </select>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                  <div class="input-group has-validation">
                    <select class="form-select" id="kitchen" name="kitchen">
                      ...
                      <?php 
                        for($i=1;$i<=5;$i++){
                          $selected = (isset($propertyDetails['kitchen']) && $i == $propertyDetails['kitchen']) ? 'selected' : '';
                          echo '<option value="'.$i.'"'.$selected.'>'.$i.'</option>';
                          }?>
                    </select>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-5">
                    <div class="input-group has-validation">
                      ...
                      <?php 
                          ...
                          ?>
                              <img src="<?php echo WEB_URL;?>/img/<?php echo $propertyDetails['agentId'];?>/<?php echo $propertyDetails['floorPlanImage'];?>" class="img-responsive thumbnail mt-2" id="pre_img" width="100" height="100" >
                          <?php
                            } else {
                          ?>
                              <img src="#" class="img-responsive thumbnail" id="pre_img" width="100" height="100" style="display:none;" >
                          <?php 
                          } 
                          ?>
                    </div>
                ...
                <div class="col-md-5">
                  <div class="input-group has-validation">
                    ...
                    <div class="col-xs-4 m-2" id="<?php echo str_replace(".","",$val);?>">
                        ...
                        <a href="javascript:void(0);"><img id="close<?php echo $val; ?>" class="delete-img" src="<?php echo AGENT_URL;?>/images/cancel-icon.png"></a>
                    </div>
                    <?php	
                        $i++;
                        }
