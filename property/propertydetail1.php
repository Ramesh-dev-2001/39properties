                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php 
                                            echo (in_array($propertyDetails['categoryId'],[1,3,4])) ? $propertyDetails['price'] : 'Negotiable';
                                        ?>
                                        </div>
...
<script src="https://apis.google.com/js/platform.js" async defer></script>
   <script>
    function onSignIn(googleUser) {
      ...
      console.log('Email: ' + profile.getEmail()); // This should now include the email
    }
    ...
    gapi.load('auth2', function() {
      gapi.auth2.init({
        client_id: '1067574441602-vb8lia3m1enbrtt8140r127gkq5i8o9o.apps.googleusercontent.com',
        scope: 'profile email'
      });
    });
  </script>
